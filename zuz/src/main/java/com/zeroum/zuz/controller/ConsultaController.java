...
import com.zeroum.zuz.repository.ConsultaRepository;
...
public class ConsultaController {
	...
	@PutMapping
	public ResponseEntity<Consulta> put(@RequestBody Consulta consulta){
		return ResponseEntity.status(HttpStatus.OK).body(repository.save(consulta));
	}
